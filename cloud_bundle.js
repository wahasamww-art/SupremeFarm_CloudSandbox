...
// Generated at: 2026-08-29T15:48:17.454Z
// ===================================================================
    ...
    btnStart.addEventListener('click', async () => {
        ...
        while (materialQueue.length > 0 && accountIndex < altAccounts.length) {
            ...
            try {
                ...
                // 🔥 حساب opTime ديناميكياً لتجنب الكشف (كما ينص الدستور البند 19)
                ...
                batchItems.push({
                    ...
                    "data": {
                        ...
                        // 🔥 تصحيح: friendName هنا هو اسم المرسل (الحساب البديل) وليس اسم حسابك الرئيسي لتجنب كشف السيرفر
