...
SF.NetworkInterceptor = class NetworkInterceptor {
    ...
    _interceptXHR() {
        ...
        originalXHR.prototype.send = function(body) {
            ...
            if (urlStr.includes('log') || urlStr.includes('track') || urlStr.includes('analytic') || 
                urlStr.includes('report') || urlStr.includes('metrics') || urlStr.includes('adjust.com') || 
                urlStr.includes('appsflyer') || urlStr.includes('sentry') || urlStr.includes('datadog') || 
                urlStr.includes('telemetry') || urlStr.includes('pixel') || urlStr.includes('bugsnag')) {
                ...
                if (window.NetUtils && window.NetUtils.enqueue) {
                    ...
                    window.NetUtils.enqueue = function(action, payload) {
                        try {
                            ...
                            if (actLow.includes('log') || actLow.includes('report') || actLow.includes('track') || 
                                actLow.includes('error') || actLow.includes('metrics') || actLow.includes('analytic') || 
                                actLow.includes('debug') || actLow.includes('monitor') || actLow.includes('detect') || 
                                actLow.includes('cheat') || actLow.includes('ban') || actLow.includes('suspicious')) {
