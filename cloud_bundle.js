...
SF.ProductionSchedulerModule = class ProductionSchedulerModule extends SF.ModuleBase {
    ...
    _updateBadge(key) {
        ...
        if (!this.badges[key]) {
            ...
            b.style.cssText = 'position:absolute;background:rgba(20,20,30,0.85);color:#fff;padding:8px 12px;border-radius:8px;font-size:13px;font-weight:bold;font-family:sans-serif;white-space:nowrap;transform:translate(-50%,-100%);border:1px solid #3498db;box-shadow:0 4px 10px rgba(0,0,0,0.5);pointer-events:auto;z-index:9000;display:flex;flex-direction:column;gap:4px;cursor:pointer;transition:all 0.2s;';
            b._expanded = false;
            b.addEventListener('mouseenter', () => b._isHovered = true);
            b.addEventListener('mouseleave', () => b._isHovered = false);
            b.addEventListener('click', (e) => { e.stopPropagation(); b._expanded = !b._expanded; this._updateBadge(key); });
            this._ensureBadgeContainer();
    ...
    _positionBadges() {
        ...
        badgeKeys.forEach(key => {
            ...
            try {
                ...
                positions[key] = {
                    sx: originSx,
                    sy: hitTop - 10,   // موقع الـ badge (فوق الـ bounding box الحقيقي بـ 10px)
