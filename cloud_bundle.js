    ...
    injectBackground() {
        ...
        const isBgUrl = (url) => {
            ...
            if (u.includes('loading') || u.includes('login') || u.includes('splash') || 
                u.includes('bg_') || u.includes('bg.') || u.includes('cover') || u.includes('scene4_bg') || u.includes('background')) {
                ...
                // Allow jpg, png, webp, jpeg, or URLs with query params that don't have extensions
                return true;
            }
            return false;
        };
