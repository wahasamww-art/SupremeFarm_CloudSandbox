...
SF.ProductionSchedulerModule = class ProductionSchedulerModule extends SF.ModuleBase {
    ...
    _processMachine(key, item, mo, sd, sched) {
        ...
        // Guard: machine is completely idle (start_time=0, no products) — nothing to collect
        if (!hasProducts && (mo.start_time === 0) && typeof mo.getProducts === 'function' && mo.getProducts() === 0) {
