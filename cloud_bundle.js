...
SF.NetworkInterceptor = class NetworkInterceptor {
    ...
    _interceptXHR() {
        ...
        originalXHR.prototype.send = function(body) {
            ...
            // Body passes through unchanged — the AMF client already sends correct Uint8Array
            // Blob conversion was removed because it breaks CORS (browser handles Blob send differently from Uint8Array send)
